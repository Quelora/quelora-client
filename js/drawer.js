...
class Drawer {
    ...
    /** @type {number} Counts open drawers */
    static openDrawersCount = 0;
    ...
    close(fromHistory = false) {
        ...
        if (wasActive) {
            ...
            if (Drawer.drawerStack.length > 0) {
                ...
                previousDrawer.open();
                Drawer.activeDrawer = previousDrawer;
            }
        }
    ...
    destroy() {
        ...
        if (Drawer.openDrawersCount > 0) Drawer.openDrawersCount--;

        if (Drawer.openDrawersCount === 0) Drawer.unlockBodyScroll();
